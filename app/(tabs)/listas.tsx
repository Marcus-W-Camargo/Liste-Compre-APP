...
import { useAuth } from '@/providers/AuthProvider'; import { useCloud } from '@/providers/CloudProvider'; import { carregarSessaoCompra } from '@/storage/purchaseSession'; import { dataPrevistaValida, formatarDataPrevistaParaExibicao, formatarEntradaDataPrevista, normalizarDataPrevista } from '@/domain/list'; import type { ListaSalva } from '@/types'; import { colors, fonts, radii } from '@/theme';
...
export default function ListsTab() {
  ...
  function openActions(list: ListaSalva) { if (list.id === activePurchaseListId) return; setSelected(list); setName(list.nome); setDate(formatarDataPrevistaParaExibicao(list.dataPrevista ?? '')); setError(''); }
