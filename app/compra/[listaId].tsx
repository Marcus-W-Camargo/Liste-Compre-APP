...
const styles = StyleSheet.create({
  ...
  inputs: { flexDirection: 'row', flexWrap: 'wrap', gap: 4, marginTop: 9, alignItems: 'flex-end', width: '100%' }, priceColumn: { flex: 1, minWidth: 88 }, quantityColumn: { width: 76 }, measureColumn: { width: 64 }, inputLabel: { height: 12, lineHeight: 10, fontFamily: fonts.semibold, fontSize: 8, marginBottom: 3 },
