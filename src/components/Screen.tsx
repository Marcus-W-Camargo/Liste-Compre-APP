import { KeyboardAvoidingView, Platform, ScrollView, StyleSheet, View, type PropsWithChildren } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  flex: { flex: 1 },
  content: { width: '100%', maxWidth: 720, alignSelf: 'center', paddingBottom: 36 },
  padded: { paddingHorizontal: 16, paddingTop: 14 },
